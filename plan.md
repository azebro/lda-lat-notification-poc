...
11. Add unit tests for valid/invalid envelope parsing, deterministic audit paths, conditional-create duplicate behavior including `409`, structured metadata extraction, and cancellation/error propagation. Use an interface around Blob persistence so normal unit tests require no Azure services.
